...
| ---------------- | ------------ | ------------ | -------------------------------------- | ----------- | ----------- | ---------- | ------------- |
| **ARIMA(3,0,1)** | **-1956.97** | **-1930.93** | ✅ ar1, ar2, ar3, ma1 (all significant) | **0.04262** | **0.02986** | **0.7017** | ✅ -0.00055    |
| ARIMA(1,0,3)     | -1955.27     | -1929.23     | ✅ ar1, ma1–ma3 (all significant)       | 0.04269     | 0.02986     | 0.7009     | ✅ -0.00758    |
| ARIMA(3,0,2)     | -1955.09     | -1924.71     | ⚠️ ma2 not significant                 | 0.04262     | 0.02985     | 0.7015     | ✅ -0.00251    |
| ARIMA(3,0,3)     | -1953.10     | -1918.38     | ⚠️ ar1, ar3 not significant            | 0.04262     | 0.02985     | 0.7010     | ✅ -0.00136    |
| ARIMA(0,0,2)     | -1952.71     | -1935.35     | ✅ ma1, ma2, intercept                  | 0.04294     | 0.03003     | 0.7058     | ✅ -0.00081    |
...
* **All Main Coefficients Significant**:
  ...
  * ar1–ar3 and ma1 all have **p-values < 0.001**, indicating strong statistical support.
  * Intercept is marginally significant (p ≈ 0.076), still acceptable.
...
* **Clean Residual Behavior**:
  ...
  * Residual autocorrelation at lag 1 is minimal (ACF1 ≈ -0.00055).
...
| Model                         | AIC          | BIC          | Significant Coefs      | RMSE        | MAE         | MASE       | Residual ACF1 |
| ----------------------------- | ------------ | ------------ | ---------------------- | ----------- | ----------- | ---------- | ------------- |
| **SARIMA(3,0,1)(0,0,0)\[12]** | **-1956.97** | **-1930.93** | ✅ ar1–ar3, ma1         | **0.04262** | **0.02986** | **0.7017** | ✅ -0.00316    |
| SARIMA(3,0,1)(0,0,1)\[12]     | -1956.16     | -1925.78     | ⚠️ Not all significant | 0.04258     | 0.02988     | 0.7022     | ✅ -0.00392    |
| SARIMA(3,0,1)(1,0,0)\[12]     | -1956.11     | -1925.73     | ⚠️ Not all significant | 0.04258     | 0.02989     | 0.7024     | ✅ -0.00394    |
| SARIMA(1,0,3)(0,0,0)\[12]     | -1955.27     | -1929.23     | ✅ ar1, ma1–ma3         | 0.04269     | 0.02986     | 0.7009     | ⚠️  0.00635   |
| SARIMA(3,0,2)(0,0,0)\[12]     | -1954.38     | -1919.66     | ⚠️ ma2 not significant | 0.04262     | 0.02985     | 0.7015     | ✅ -0.00085    |
...
* **All Key Coefficients Statistically Significant**:
  ...
  * Intercept p = 0.076 is marginally significant — acceptable.
...
| Criteria                       | **ARIMA(3,0,1)** | **SARIMA(3,0,1)(0,0,0)\[12]** | ✅ Best   |
| ------------------------------ | ---------------- | ----------------------------- | -------- |
| **AIC**                        | **-1956.97**     | **-1956.97**                  | ⚖️ Tie   |
| **BIC**                        | **-1930.93**     | **-1930.93**                  | ⚖️ Tie   |
| **RMSE**                       | 0.04262          | 0.04262                       | ⚖️ Tie   |
| **MAE**                        | 0.02986          | 0.02986                       | ⚖️ Tie   |
| **MASE**                       | 0.7017           | 0.7017                        | ⚖️ Tie   |
| **Residual ACF1**              | -0.00055         | -0.00316                      | ✅ SARIMA |
| **Ljung-Box p-value (lag=12)** | ✅ 0.3219         | ✅ 0.3219                      | ⚖️ Tie   |
| **Significant Coefficients**   | ✅ All            | ✅ All                         | ⚖️ Tie   |
| **Seasonal Terms Present**     | ❌ No             | ❌ No (seasonal syntax only)   | ⚖️ Tie   |


### **Updated Insight: ARIMA vs SARIMA Final Comparison**
...
fit_garch_models <- function(data, p_list = 0:2, q_list = 0:2) {
  ...
  for (p in p_list) {
    for (q in q_list) {
      ...
      # Skip invalid models like GARCH(0,0)
      if (p == 0 && q == 0) next
...
# Print AIC/BIC of successful models
for (model in names(garch_results)) {
  cat(model, ": AIC =", garch_results[[model]]$AIC,
      " BIC =", garch_results[[model]]$BIC, "\n")
}
